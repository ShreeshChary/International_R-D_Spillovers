...
xtpedroni lf lsd lsfch, lags(3) notest 
xtpedroni lf lsd lsflp, lags(3) notest 
xtpedroni lf lsd mlsfch, lags(3) notest
xtpedroni lf lsd mlsflp, lags(3) notest
xtpedroni lf lsd lsfch lh, lags(3) notest
xtpedroni lf lsd lsflp lh, lags(3) notest
xtpedroni lf lsd mlsfch lh, lags(3) notest
xtpedroni lf lsd mlsflp lh, lags(3) notest

****************************************************************************************************************

**POLS ECM

qui reg dlf llf llsd llsflp dlsd  dlsflp, robust 
...
scalar tsig=-999
reg dlf llf llsd llsflp dlsd dlsflp, robust
scalar rmse=e(rmse)
predict ePOLS
xtcd ePOLS
scalar drop _all
...
xtdcce2 d.lf d.lsd d.lsflp, cr_lags(0) lr_options(nodivide) lr(l.lf lsd lsflp) cr(_all)
predict eCCEMG, residuals
xtcd eCCEMG
