...
xtcaec lf lsd lsflp, lags(1) calags(2) select mg res(D1) avlr
xtcd D1
xtcaec lf lsd lsflp lh, lags(1) calags(2) select mg res(D2) avlr
xtcd D2
xtcaec lf lsd lsflp if g7==1, lags(1) calags(2) select mg res(D3) avlr
xtcd D3
xtcaec lf lsd lsflp lh if g7==1, lags(1) calags(2) select mg res(D4) avlr
xtcd D4
xtcaec lf lsd lsflp if g7==0, lags(1) calags(2) select mg res(D5) avlr
xtcd D5
xtcaec lf lsd lsflp lh if g7==0, lags(1) calags(2) select mg res(D6) avlr
xtcd D6
